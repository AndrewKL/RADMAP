/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2012-05-19 00:50:13 -0300 (Sat, 19 May 2012) $
 * $Revision: 17157 $
 *
...
//final static int contact      see mathfunc
  ...
  final static int radicalanalyzer           = 22 | 0 << 9 | mathfunc | scriptCommand;
  final static int generategaussianinputfile           = 23 | 0 << 9 | mathfunc | scriptCommand;
  final static int generatesurfaceverticesfile           = 24 | 0 << 9 | mathfunc | scriptCommand;
  final static int loadradicalanalyzer           = 25 | 0 << 9 | mathfunc | scriptCommand;
...
// see intparam  public final static int specular                       = booleanparam | 174;
  ...
  static {
    ...
    // commands
      ...
      "radicalanalyzer",    new Token(radicalanalyzer),
      "loadradicalanalyzer",  new Token(loadradicalanalyzer),
      "generategaussianinputfile",    new Token(generategaussianinputfile),
      "generatesurfaceverticesfile", new Token(generatesurfaceverticesfile),
      "zap",               new Token(zap),
      "zoom",              new Token(zoom),
