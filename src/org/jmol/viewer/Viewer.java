...
public class Viewer extends JmolViewer implements AtomDataServer {
  ...
  */
  ...
  public void setPickingMode(String strMode, int pickingMode) {  
    /*uses ints from ActionManager which represent various actions. ala Delete atom \
     *needs either a strMode or a int pickingmode see Action manager
     *calls setPickingMode in the actionmanager 
     */
    
    //System.out.println("setPickingMode:  strMode: "+strMode);
    if (!haveDisplay)
      return;
    showSelected = false;
    String option = null;
  ...
  public void setStatusAtomPicked(int atomIndex, String info) {
    System.out.println("setStatusAtomPicked: atomindex: "+atomIndex+"  info: "+info);
    if (info == null) {
  ...
  public void setModelKitMode(boolean value) {
    //System.out.println("setModelKitMode:  "+value+"  modelkitsidemune: "+modelKitSideMenu);
    if(modelKitSideMenu != null){
      modelKitSideMenu.setVisible(value);
      modelKitSideMenu.validate();
      modelKitSideMenu.repaint();
    }
  ...
  private ModelKitSideMenu modelKitSideMenu; 
  
  public void setModelKitSideMenu(ModelKitSideMenu inc){
    modelKitSideMenu = inc;
  ...
  Map<String, Object> checkObjectClicked(int x, int y, int modifiers) { //whats this?  maybe 
    return shapeManager.checkObjectClicked(x, y, modifiers, getVisibleFramesBitSet());
  }
  ...
  public void setSelectedAtom(){
    System.out.println("setting atom selection");
