...
public class ActionManager {
  ...
  public final static int ACTION_assignFragment = 47;
  public final static int ACTION_selectAtom = 48;//to set position for addition of the fragment
  
  public final static int ACTION_count = 49;
  ...
  static void newAction(int i, String name, String info) {
    System.out.println("newAction:  i: "+i+"  name: "+name+"  info: "+info);
    actionInfo[i] = info;
    actionNames[i] = name;
  }
  ...
  public final static int PICKING_ADD_FRAGMENT     = 36; //adds fragment to current model
  public final static int PICKING_LOCATION_FOR_ADDITION     = 37;//sets the location in which the fragment will be added to the model
  ...
  private final static String[] pickingModeNames = {
    ...
    "invertstereo", "assignatom", "assignbond", "rotatebond", "identifybond","assignFragment"
  };
  ...
  private final static String[] pickingStyleNames = {//what is this for?
  ...
  public void mouseAction(int action, long time, int x, int y, int count,
    ...
    case Binding.CLICKED:
      ...
      checkPointOrAtomClicked(x, y, modifiers, clickedCount, time, false,
          Binding.CLICKED);
      if(atomPickingMode == PICKING_SELECT_ATOM){
        System.out.println("mouse action picking select atom");
  ...
  public void minimize(boolean dragDone) {
  ...
  public void setAddFragmentPickingMode(){
    
  }
    
  public void setPickingMode(int pickingMode) {
    //System.out.println("setPickingMode: "+pickingMode);
    switch (pickingMode) {
    ...
    case PICKING_SELECT_ATOM:
      System.out.println("picking_select_atom");
    }
