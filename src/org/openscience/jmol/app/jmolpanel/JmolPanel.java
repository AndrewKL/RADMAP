...
import org.openscience.jmol.app.ModelKitSideMenu;
...
public class JmolPanel extends JPanel implements SplashInterface, JsonNioClient {
  ...
  protected IsosurfacePESDialog isosurfacePESDialog;
  protected FlexSurfaceDialog flexSurfaceDialog;
  ...
  //private JToolBar modelKitToolbar;//new 
  ...
  private static final String isosurfacePESAction = "isosurfacePES";
  private static final String FlexSurfaceAction = "FlexSurface";
  ...
  public ModelKitSideMenu modelKitSideMenu;
  ...
  public JmolPanel(JmolApp jmolApp, Splash splash, JFrame frame,
    ...
    if (jmolApp.isKiosk) {
      ...
      //builds the JMOL application GUI  <--- important
      ...
      modelKitSideMenu = new ModelKitSideMenu(viewer);
      Viewer viewer2 = (Viewer)viewer;
      System.out.println("modelkit side menu set up viewer2: "+viewer2);
      viewer2.setModelKitSideMenu(modelKitSideMenu);
      panel.add("West", modelKitSideMenu);
...
//  }
  ...
  private Action[] defaultActions = { new NewAction(), new NewwinAction(),
      ...
      new GaussianAction(),new IsosurfacePESAction(),new FlexSurfaceAction(), new ResizeAction(), surfaceToolAction }
  ;
  ...
  class IsosurfacePESAction extends AbstractAction {
    public IsosurfacePESAction() {
      super(isosurfacePESAction);
    }
    
    public void actionPerformed(ActionEvent e) {
      if (isosurfacePESDialog == null)
        isosurfacePESDialog = new IsosurfacePESDialog(frame, viewer);
      isosurfacePESDialog.setVisible(true);
    }
  }
  
  class FlexSurfaceAction extends AbstractAction {
    public FlexSurfaceAction() {
      super(FlexSurfaceAction);
    }
    
    public void actionPerformed(ActionEvent e) {
      if (flexSurfaceDialog == null)
        flexSurfaceDialog = new FlexSurfaceDialog(frame, (Viewer)viewer);
      flexSurfaceDialog.setVisible(true);
    }
  }
  ...
  void updateLabels() {
    ...
    if (isosurfacePESDialog != null) {
      isosurfacePESDialog.dispose();
      isosurfacePESDialog = null;
    }
    if (flexSurfaceDialog != null) {
      flexSurfaceDialog.dispose();
      flexSurfaceDialog = null;
    }
